	...
	<section id="intro">
		<ul id="slippry-slider">
			<li><a href="#slide1"><img src="assets/img/slide/1.jpg"
					alt=""></a></li>
			<li><a href="#slide2"><img src="assets/img/slide/2.jpg"
					alt=""></a></li>
			<li><a href="#slide3"><img src="assets/img/slide/3.jpg"
					alt=""></a></li>
			<li><a href="#slide3"><img src="assets/img/slide/4.jpg"
					alt=""></a></li>
			<li><a href="#slide3"><img src="assets/img/slide/5.jpg"
					alt=""></a></li>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="sub-heading">
						<p>Introducing new watches from our store</p>
					</div>
				</div>
			</div>
			<div class="row">
